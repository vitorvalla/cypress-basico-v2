...
describe('Central de Atendimento ao Cliente TAT', function (){
    ...
    beforeEach('Acessar Navegador', function(){
    ...
    it('preenche os campos obrigatórios e envia o formulário', function (){
        ...
        cy.get('#email').type('vitorvalladaoms@gmail.com');
    ...
    it ('preenche e limpa os campos nome, sobrenome, email e telefone', function (){ 
        ...
        cy.get('#lastName')
        .type('Valladão')
        .should('have.value', 'Valladão')
        .clear()
        .should('have.value', '');

        cy.get('#email')
        .type('vitorvalladaoms@gmail.com')
        .should('have.value', 'vitorvalladaoms@gmail.com')
        .clear()
        .should('have.value', '');
